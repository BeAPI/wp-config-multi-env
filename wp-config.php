...
/************************************************************************
 *  OVERRIDING WP Config for dev/qualif/preprod/client preprod servers  *
 ************************************************************************/
...
if ( is_file( dirname( __FILE__ ) . '/../env_dev' ) ) {
	...
	return true;
} elseif ( is_file( dirname( __FILE__ ) . '/../env_preprod_client' ) ) {
	if ( is_file( dirname( __FILE__ ) . '/../wp-config-preprod-client.php' ) ) {
		require( dirname( __FILE__ ) . '/../wp-config-preprod-client.php' );
	} elseif ( is_file( dirname( __FILE__ ) . '/wp-config-preprod-client.php' ) ) {
		require( dirname( __FILE__ ) . '/wp-config-preprod-client.php' );
	} else {
		die( 'No preprod config' );
	}
